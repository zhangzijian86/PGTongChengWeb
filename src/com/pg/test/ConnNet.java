...
public class ConnNet 
{
	...
	private static final String URLVAR="http://139.196.189.30:8000/WebApi/DataExchange/GetData/SeaBridge_OrganiseUnit_QueryList?dataKey=00-00-00-00&Syncdatetime=1970-01-01";
	...
	public HttpURLConnection getConn(String urlpath)
	{
		...
		try {
			...
			System.out.println("==================111=="+url.toString());
	...
	public HttpGet gethttGet() 
	{	
		HttpGet httpget=new HttpGet(URLVAR);	
